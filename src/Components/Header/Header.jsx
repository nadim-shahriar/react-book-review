    ...
    return (
        <div className="navbar bg-base-100 my-5 container mx-auto">
            <div className="navbar-start">
                ...
                <Link to={'/'}><a className="btn btn-ghost font-bold text-xl">Book Vibe</a></Link>
            </div>
            ...
            <div className="navbar-end gap-3">
                <a className="btn bg-[#23BE0A] lg:text-xl text-white">Sign In</a>
                <a className="btn bg-[#59C6D2] lg:text-xl text-white">Sign Up</a>
            </div>
        </div>
    );
};
